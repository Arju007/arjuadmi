...
'adm/index.php','adm.php','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php','webcp']
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    try: 
        ...
        print(" _  _  __  ___  _   _  __  ____  _  _  ___  ____ ")
        print("coded by :")
        print("      ArjuNaN :")
        print("             injector=>46JU_N4N")
        print(" _  _  __  ___  _   _  __  ____  _  _  ___  ____ ")
        print("")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("")
